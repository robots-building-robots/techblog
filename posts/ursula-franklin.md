...
Franklin was no Luddite. She acknowledged the genuine gains the personal computer was introducing at that time: word processing, instant communication, access to information. But she also noted how it was systematically eroding essential human skills: spelling, arithmetic, handwriting. 

*Every new technology is marketed as liberating*. But in the *technology hype cycle*, there is a steep drop from the peak of "youthful exuberance" into disillusionment. Today, social media has largely followed the same arc. Marketed as connection and community, it has mostly delivered distraction, addiction, misinformation and surveillance. What begins as voluntary adoption of new technologies becomes dependency on its frictionless conveniences. By the time a technology is ubiquitous and institutionalized, opting out becomes too professionally and socially costly to be a real choice.

The advent of LLMs has been no exception. Framed as tools that extend rather than displace human authorship, they have arrived wrapped in the language of holistic technology: *"supercharge your productivity", "your AI assistant", "copilot"*. Used with care and intention, LLMs can be genuinely assistive tools. The researcher who retains authorship, the experienced developer who uses code completion as a guide rather than "vibe coding", a person with a disability navigating a world not designed for them — these are uses where the technology extends human capacity rather than replacing it.
