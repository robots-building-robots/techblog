...
*Every new technology is marketed as liberating*. Franklin was no Luddite — she acknowledged the genuine gains the personal computer was introducing: word processing, instant communication, access to information. But she also noted how it systematically displaced essential human skills: spelling, arithmetic, handwriting. In the technology hype cycle, there is a steep drop from the peak of "youthful exuberance" into disillusionment. Social media has largely followed the same arc — marketed as connection and community, it has delivered surveillance, addiction, and the erosion of sustained attention. What begins as voluntary adoption becomes dependency on addictive, frictionless conveniences. By the time a technology is normalized through growing adoption and institutionalization, opting out becomes too professionally and socially costly to be a real choice.

The advent of LLMs has been no exception. Framed as tools that extend rather than displace human authorship, they arrive wrapped in the language of holistic technology: *"supercharge your productivity", "your AI assistant", "copilot"*. Used with intention, LLMs can function as genuinely assistive tools. Consider the researcher who retains authorship and judgment, the developer using code completion as suggestion rather than instruction, the translator preserving a writer's voice, the person with a disability navigating a world not designed for them — these are uses where the technology extends human capacity rather than displacing it.

But as we observe how LLMs are actually being aggressively deployed, and without meaningful reciprocity at any level, the question of how prescriptive they are by design becomes harder to avoid. Children are automating homework rather than developing the capacity to structure thought and argument. In the workplace, craft is being quietly fragmented, not yet replacing workers wholesale, but systematically hollowing out the skills and judgment that make work meaningful.

Perhaps most troubling, increasingly isolated and dependent on prescriptive technologies, many are turning to LLMs for emotional support and companionship — substituting the mimicry of communication for the real thing. Social media platforms were built on the same logic: algorithmic engagement, rage-bait, the manufacture of connection. Isolation and dependency are not side effects of these systems; they are features. Fragmentation feeds loneliness, loneliness feeds dependency, dependency demands more of the technology that produced it. Loneliness, it turns out, is enormously profitable.
...
*LLMs are prescriptive by design*. The user is reduced to the prompt —thinking, structuring, judging, writing— the entire holistic process of making displaced into the system. What presents itself as reciprocal communication is just feedback: the system makes adjustments within its own predetermined logic, producing outputs shaped by its training rather than by the user's genuine needs. Some LLM platforms simulate responsiveness, asking clarifying questions, requesting permission before executing, but this is feedback masquerading as reciprocity. Clarifying questions gather parameters to better execute the system's own logic. The parameters of the exchange are set by the system, not genuinely negotiated.

Franklin's concept of reciprocity operates on distinct levels: at the interface, at the workflow, and at the political. Interface-level responsiveness, however convincing, leaves the deeper levels untouched. Reciprocity foreclosed at the political level —who decides how these systems are built, deployed, and regulated— is the most consequential, and the least visible.

The result is a compliance culture extended to human expression itself. The terms of thought dictated by the machine. Franklin's culture of compliance was about how prescriptive technologies reshape work and institutions. LLMs push that logic further: into language, reasoning, and creativity — the last domains we assumed were irreducibly human. Yet the question is not simply whether LLMs are prescriptive, but whether they could be designed and used differently.
...
These questions become only more urgent as prescriptive technologies like LLMs are adopted at scale. Are we using these tools in ways that retain human authorship and judgment, or are we quietly deferring to the machine's output? Are we building products that extend the user's capacity, or ones that redirect their dependency toward our platform? Are we reaching for the most convenient, most heavily marketed tool — or asking whether a lighter, more transparent, more privacy-respecting alternative exists? Locally run models, open source platforms, and tools that keep data sovereign are not merely technical preferences. Measured against Franklin's checklist, they are more principled choices.

None of this is straightforward in workplaces where LLM adoption is being driven from above, often without meaningful consultation. The reciprocity Franklin calls for is frequently absent at every level — interface, workflow, and policy. In that context, earthworming means what it has always meant: advocating within teams and organizations for more open debate, refusing uses that hollow out craft or concentrate power, supporting open alternatives where possible, and insisting that the question of how these tools are built and deployed belongs in public discourse.

We are downstream of decisions made without our input. Pushing back against the torrent of large technology platforms', "Big Tech", prescriptive technology can feel overwhelming. How do we, as makers in the real world of technology where Franklin's warnings have gone largely unheeded, stay principled, let alone relevant? When the system offers no reciprocity by design, how do we act beyond demanding more of it from politicians and industry leaders who offer no meaningful policy response?
