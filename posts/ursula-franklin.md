...
Franklin was no Luddite. She acknowledged the genuine gains the personal computer was introducing: word processing, instant communication, access to information. But she also noted how it was systematically eroding essential human skills: spelling, arithmetic, handwriting. Every new technology is marketed as liberating. But in the technology hype cycle, there is a steep drop from the peak of 'youthful exuberance' into disillusionment. Social media is the cautionary example: marketed as connection and community, it has mostly delivered distraction, addiction, misinformation, and surveillance. What begins as voluntary adoption becomes dependency on frictionless conveniences. By the time a technology is normalized, opting out becomes too professionally and socially costly to be a real choice.

The advent of LLMs has been no exception. Framed as tools that extend rather than displace human authorship, they have arrived wrapped in the language of holistic technology: *"supercharge your productivity", "your AI assistant", "copilot"*. Used with intention, LLMs can be genuinely assistive tools. The researcher who retains authorship, the experienced developer who uses code completion as a guide rather than "vibe coding", a person with a disability navigating a world not designed for them — these are uses where the technology extends human capacity rather than replacing it.

But as LLMs are being aggressively deployed, without meaningful reciprocity, the question of how prescriptive they are by design becomes harder to avoid. Students are automating homework rather than developing the capacity to think critically. In the workplace, craft is being fragmented, not yet replacing workers wholesale, but systematically hollowing out the skills and relationships that make work meaningful.

Perhaps most troubling, in a society where people are increasingly isolated and dependent on prescriptive tech, many are turning to LLMs for emotional support and companionship, substituting the mimicry of communication for the real thing. LLMs are inheriting the business model of the social media platforms with algorithmic engagement and manufactured connection. Isolation and dependency are not side effects of these systems; they are features. Fragmentation leads to isolation, isolation forms dependency, dependency demands more of the technology that produced it. Loneliness, it turns out, is enormously profitable.
...
*LLMs are prescriptive by design*. The user is either reduced to the prompt —thinking, judging, writing— the entire holistic process of making absorbed into the system; or, in the case of agentic systems, the maker is reduced to a manager of agents or removed from the workflow entirely. Some platforms simulate responsiveness at the interface level —asking clarifying questions, requesting permission before executing— but this is feedback masquerading as reciprocity. What presents itself as communication is the system adjusting within its own predetermined logic, not responding to those who use it. Interface-level responsiveness —even a "human in the loop"— does not reach the level that matters most: who decides how these systems are built, deployed, and regulated. That foreclosure of reciprocity is by design, not oversight.
