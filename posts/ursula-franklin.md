...
Franklin's checklist is not a prescribed formula; it is a set of questions anyone building or deploying technology should return to at every stage of the process. In practice, we should be asking ourselves: Who benefits from what we are building, and who is excluded? Are the people most affected by our decisions involved in making them? Are we designing for reversibility, avoiding lock-in, favouring open and interoperable systems? Are we measuring the true cost of what we ship, not only in compute and capital, but in social and ecological impact? How do we define the line between authorship and automation?
