...
What would Franklin say about the aggressive, largely unregulated roll-out of AI into our workplaces and daily lives? What might a more *responsible* approach look like?

## Prescriptive Technologies

Franklin defines technology not as a collection of tools, but as a *comprehensive social practice* that dictates human relationships and structures power. She distinguishes between two fundamental categories: holistic and prescriptive. *Holistic technologies* are the tools of the craftsperson —the stonemason, the weaver, the independent developer who custom codes software— where a single maker oversees production from inception to completion, exercising judgment at every stage. *Prescriptive technologies* fragment production into discrete, managed steps —the assembly line, the fulfillment centre— displacing autonomy into layers of management and monitoring. The maker no longer makes; they *comply*.

The fragmentation of work into prescribed steps *institutionalizes dependency and standardization*. Where holistic practice thrives on collaboration and shared judgment, prescriptive workflows reduce the relationships of a community of practice to mere process. Outputs converge toward what the system permits rather than what the makers envision. Variation is rebranded as waste, deviation as error, regardless of any potential merit. As collaboration and judgment is excised from the workflow, skill and creativity atrophy. *Automation bias* takes hold, and the machine's answer becomes the default. Over time, prescriptive technologies do not merely change how work is done; they reshape social relations in their own image, organized around production, efficiency, and top-down management rather than the communities they serve.
...
In cultures of compliance, "*people are seen as sources of problems while technology is seen as the source of solutions*"[^Franklin]. This "*anti-people mindset*"[^Franklin] favours a model of *production over growth*, where environments are engineered for technological optimization rather than the lived experience of people within them. When the logic of production becomes totalizing, it flattens all other social relations —those based on compassion, obligation, ecological responsibility— until only the transactional remains. *If the medium is the message, the message of prescriptive tech is compliance*.
...
The answer is not more regulation for its own sake. Poorly designed policy can stifle the real gains technology offers just as effectively as unchecked markets erode them. What Franklin calls for is *better governance*, not a blanket brake on innovation. LLMs themselves may prove useful here: accelerating research and providing the impact modeling that better policy requires.

In a business context, a culture of compliance is a hidden liability. Prescriptive systems are inherently brittle; they optimize for efficiency at the cost of resilience. By reducing users and employees to passive components in a feedback loop, organizations suffer from compliance fatigue and the erosion of the very human judgment required to navigate edge cases or systemic failures. Responsible production is therefore not merely an ethical choice, but a transition from a model of extraction to one of partnership.
...
While marketed as open-ended collaborators, the architecture of LLMs reveals a deeply prescriptive core. LLMs are prescriptive by design, powered by the logic of probability. Because they calculate the most statistically likely response rather than exercising holistic judgment, they function as closed loops of statistical averages. They cannot question the moral weight, validity, or wisdom of a goal; they can only optimize the most likely path toward it—effectively foreclosing any alternative possibilities.
