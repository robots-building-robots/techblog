...
Infrastructure isn't neutral. The same data pipelines and AI systems powering our productivity tools are procured for unlawful surveillance, policing, and warfare. The small print doesn't mention that. And none of it is more ethical for being algorithmic.
...
I've started where impact is highest and disruption lowest, while weighing cost, effort, and the convenience of consolidating under one provider where it makes sense. It's grouped into four layers — **Identity, Data, Communications, and Consumption** — ordered by impact on privacy, security, and sovereignty.
...
<div class="card">
  ...
  <small>
    ...
    - Swiss jurisdiction, strong privacy law<br>
...
<div class="card">
  ...
  <small>
    ...
    - Chrome kept for development and QA<br>
    - A browser with a tiny market share, e.g. firefox, isn't really viable as a web developer because you won't see your work the way most users do.<br>
  </small>
...
<div class="card">
  <h3>DNS</h3>
  <p><strong>Default ISP</strong>&nbsp; → &nbsp;<i>In Progress…</i></p>
</div>
